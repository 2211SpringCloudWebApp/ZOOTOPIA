	...
	<body>
		...
		<table class="">
				...
				<tbody>
					...
					<tr>
						<td><input type="checkbox" name="rowcheck" value="${adoptPostLike.adoptPostNo }">${adoptPostLike.adoptPostNo }</td>
						<td><a href="/review/detail.ztp?postNo=${adoptPostLike.adoptPostNo}">${adoptPostLike.adoptContent}</a></td>
