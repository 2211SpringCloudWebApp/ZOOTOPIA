...
public class MyComment {
	...
	public MyComment(String boardId, String postNo, int commentNo, int parentCommentNo, String commentContent, String commentWriterId, Timestamp commentCreateDate) {
